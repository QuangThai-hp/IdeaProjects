...
class ThemCaNhan with ChangeNotifier {
  ...
  final String? field_nguon_khach;
  ...
  final String? field_duong_pho;
  final String? field_dia_chi;
  final String? field_huong;
  final String? field_phap_ly;
  final String? field_tinh_trang_noi_that;
  final String? field_chieu_dai;
  final String? field_chieu_rong;
  final String? field_dien_tich;
  final String? field_dien_tich_su_dung;
  final String? field_so_tang;
  final String? field_so_can;
  final String? field_duong;
  final String? field_so_phong_ngu;
  final String? field_so_phong_ve_sinh;
  final String? field_so_tien_coc;
